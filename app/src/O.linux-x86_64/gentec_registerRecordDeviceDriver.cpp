...
/* Generated from ../O.Common/gentec.dbd */
...
epicsShareExtern void (*pvar_func_register_func_gentecNameInit)(void);
epicsShareExtern void (*pvar_func_register_func_gentecNameProc)(void);
epicsShareExtern void (*pvar_func_register_func_gentecValInit)(void);
epicsShareExtern void (*pvar_func_register_func_gentecValProc)(void);
...
int gentec_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/reg/g/pcds/epics-dev/nrw/gentec-parent02";
    ...
    (*pvar_func_register_func_gentecNameInit)();
    (*pvar_func_register_func_gentecNameProc)();
    (*pvar_func_register_func_gentecValInit)();
    (*pvar_func_register_func_gentecValProc)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"gentec_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    gentec_registerRecordDeviceDriver(*iocshPpdbbase);
}
